...
async def on_start(msg: Message):
    text = (
        "Привіт! Це бот для анонімного надсилання \"темок\" власнику каналу Crypto Mriya.\n\n"
        "Як це працює:\n"
        ...
        "Якщо або коли я відпрацюю вашу темку, я зв'яжусь із вами та виплачу ваш %. Також можу зв'язатись для уточнення темки."
    )
